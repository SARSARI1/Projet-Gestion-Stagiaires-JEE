...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5"><i class="fa fa-graduation-cap me-3 text-primary"></i>Aperçu du Programme de Stages</h1>
        </div>

        <!-- Ajouter un formulaire pour sélectionner un département -->
        <div class="row">
      
            
                <div class="col-md-6">
                  <form id="departmentForm" class="form-group" method='post' action='DashboardChef'>
                    <label for="department" class="form-label">Sélectionnez le Département :</label>
                    <select id="department" name="deprtid" class="form-select" onchange="this.form.submit()">
                        <!-- Ajouter des options dynamiquement en fonction de vos départements -->
                ...
                <div class="col-md-6">
                <form method='post' action='DashboardChef'>
                    <label for="submitBtn" class="form-label"></label>
                    <button type="submit"  id="submitBtn" class="btn btn-primary">Afficher les Statistiques</button>
                    </form>
                </div>
        ...
        <div class="col-md-4">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    ...
                    <div class="ms-3">
                  <h6> ${affecte} ${stagesAffectes}	</h6>
				  <h6> ${nonaffecte} ${stagesNonAffectes}</h6>
				   </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    ...
                    <h6> ${Eaffecte} ${encadrantAffectes}	</h6>
